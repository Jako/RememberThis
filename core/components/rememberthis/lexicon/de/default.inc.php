...
$_lang['setting_rememberthis.outerTpl_desc'] = 'Outer templage for the list output.';
...
$_lang['setting_rememberthis.packagename_desc'] = 'xPDO package name where the added data is retreived from.';
