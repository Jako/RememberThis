...
outerTpl       | Outer templage for the list output, if the list   | @FILE components/rememberthis/templates/outerTpl.html
...
addId | If the output mode is `add`, this value (and     |
      | the correspondenting data) is added to the list. | Current resource id