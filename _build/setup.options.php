...
switch ($options[xPDOTransport::PACKAGE_ACTION]) {
    case xPDOTransport::ACTION_INSTALL:
        $output .= '<h2>Install RememberThis</h2>

        <p>Thanks for installing RememberThis. This open source extra was
    ...
    case xPDOTransport::ACTION_UPGRADE:
        $output .= '<h2>Upgrade RememberThis</h2>

        <p>RememberThis will be upgraded. This open source extra was developed by
