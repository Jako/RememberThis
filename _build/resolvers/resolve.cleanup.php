...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            if ($oldPackage && $oldPackage->compareVersion('2.3.0-pl2', '>')) {
                $cleanup = [
                    'core' => [
                        'components/rememberthis/processors/web/remember.php'
                    ]
                ];
                cleanupFolders($modx, $corePath, $assetsPath, $cleanup, 'RememberThis', '2.3.0');
            }
            $success = true;
            break;
